...
--
-- Servidor: localhost
-- Tiempo de generación: 10-09-2014 a las 01:02:40
...
--
CREATE DATABASE IF NOT EXISTS `puerto_udes` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `puerto_udes`;
...
INSERT INTO `bulto` (`id`, `nombre`, `fechaCreado`, `marca`, `clase`) VALUES
(1, '', '2014-09-08 21:08:59', 'uno', 'bultos');
...
INSERT INTO `contenedor_mercancia_formato` (`id`, `formato`, `mercancia`, `contenedor`, `bulto`, `peso_bruto`, `peso_neto`, `volumen`, `volumenOtro`, `fechaCreado`, `numero_bultos`) VALUES
(1, 5, 1, NULL, 1, NULL, NULL, NULL, NULL, '2014-09-08 21:08:59', '4');
...
INSERT INTO `formato` (`id`, `id_transportista`, `padre`, `tipo`, `incoterm`, `nombre`, `canonical`, `descripcion`, `fecha_creado`, `completo`, `numero`, `instrucciones`, `observaciones`, `fecha_emision`, `autor`) VALUES
(1, NULL, NULL, 31, NULL, 'Declaración de Tránsito Aduanero Internacional 1', 'declaracion-de-transito-aduanero-internacional-1', NULL, '2014-09-04 16:43:21', 0, 1, NULL, 'ok', '2014-09-04 16:43:21', 1),
(2, NULL, NULL, 5, NULL, 'Carta de Porte Internacional por Carretera 2', 'carta-de-porte-internacional-por-carretera-2', NULL, '2014-09-04 16:47:22', 0, 2, NULL, NULL, '2014-09-04 16:47:22', 1),
(3, NULL, NULL, 30, NULL, 'Control de Aduanas de Cruce de Frontera 3', 'control-de-aduanas-de-cruce-de-frontera-3', NULL, '2014-09-04 16:48:32', 0, 3, NULL, NULL, '2014-09-04 16:48:32', 1),
(4, NULL, NULL, 3, NULL, 'Manifiesto de Carga Internacional 4', 'manifiesto-de-carga-internacional-4', NULL, '2014-09-04 20:49:50', 0, 4, NULL, NULL, '2014-09-04 20:49:50', 1),
(5, NULL, NULL, 28, NULL, 'Remesa 5', 'remesa-5', NULL, '2014-09-04 21:07:35', 0, 5, 'Instr', 'Ok', '2014-09-04 21:07:35', 1),
(6, NULL, NULL, 32, NULL, 'Factura 6', 'factura-6', '1.-16 pales', '2014-09-08 16:22:05', 0, 6, NULL, NULL, '2014-09-08 16:22:05', 1);
...
(1, 1, 1, 11, '2014-09-04 16:43:22'),
(2, 1, 2, 11, '2014-09-04 16:47:23'),
(3, 1, 3, 11, '2014-09-04 16:48:33'),
(4, 1, 4, 11, '2014-09-04 20:49:51'),
(5, 1, 5, 11, '2014-09-04 21:07:35'),
(6, 1, 6, 11, '2014-09-08 16:22:06');
...
(1, 1, 'usuario0', 'usuario0', 'usuario0@email.com', 'usuario0@email.com', 1, 'b7nn6z5zcxwkkwkc0soo4w4004kg88o', 'm8I8WntZUI/84JlK5VB2in0A4nw13YAiZ9W0OIqIz6J0thRdRSjjgKgSIcMKo6mZ9fMgacQyUm7Z2PTdWjHu8w==', '2014-09-08 22:57:44', 0, 0, NULL, NULL, NULL, 'a:1:{i:0;s:16:"ROLE_SUPER_ADMIN";}', 0, NULL);
...
(1, NULL, NULL, '4 bultos de algo', '2014-09-08 21:08:59');
...
(28, 'Remesa', 'remesa', 'Tipo de Formato de Remesas', '2014-09-04 16:15:23', 'Formato', 'remesa'),
(29, 'Declaración de Importación', 'declaracion-de-importacion', 'Tipo de Formato Declaración de Importación', '2014-09-04 16:16:30', 'Formato', 'DI'),
(30, 'Control de Aduanas de Cruce de Frontera', 'control-de-aduanas-de-cruce-de-frontera', 'Tipo de Formato Control de Aduanas de Cruce de Frontera', '2014-09-04 16:18:28', 'Formato', 'CACF'),
(31, 'Declaración de Tránsito Aduanero Internacional', 'declaracion-de-transito-aduanero-internacional', 'Tipo de Formato Declaración de Tránsito Aduanero Internacional', '2014-09-04 16:19:25', 'Formato', 'DTAI'),
(32, 'Factura', 'factura', 'Tipo de formato Factura', '2014-09-04 21:00:30', 'Formato', 'factura');
